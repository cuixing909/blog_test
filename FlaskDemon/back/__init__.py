...
from back.api_1_0 import api,test,auth,users,posts,tags,categories,archives,comments,uploads,api_tasks
...
def add_api():
    ...
    :return:
    """
    api.add_resource(test.Test, '/api/tests', '/api/books/<string:book_id>')
    ...
    api.add_resource(uploads.UploadImage, '/api/images') # 上传文件
